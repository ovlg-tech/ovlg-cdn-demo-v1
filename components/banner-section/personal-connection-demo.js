            ...
            <aside className="col-12 col-md-5 col-lg-4">
                <div className="position-relative banner-image-group" style={{ minHeight: '360px' }}>
                    ...
                    <Image
                        ...
                        src={`${publicRuntimeConfig.rootPath}/images/compressed-banner-image-lyle-solomon.webp`}
                        placeholder="blur"
                        blurDataURL={`${publicRuntimeConfig.rootPath}/images/compressed-banner-image-lyle-solomon.webp`}
