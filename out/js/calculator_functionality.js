...
function calculateIncomeRatio() {
	...
	$.ajax({
		type: 'POST',
		url: 'https://www.ovlg.com/calc/debt-income-ratio',
		data: incomeOptions,
		dataType: 'html',
		encode: true,
		success: function(data) {
	...
	$('#2nd-tab').on("click", "#getProfessionalHelp", function() {
		window.location = "https://www.ovlg.com/contact-us/help.html"
	});
...
function calculateIncomeRatioTemplate() {
	...
	$.ajax({
		type: 'POST',
		url: 'https://www.ovlg.com/calc/debt-income-ratio-template',
		data: incomeOptions,
		dataType: 'html',
		encode: true,
		success: function(data) {
...
function calculateApr() {
	...
	$.ajax({
		type: 'POST',
		url: 'https://www.ovlg.com/calc/debt-apr-calculators',
		data: aprValue,
		crossDomain: true,
		dataType: 'html',
		encode: true,
...
function CalculateCredits() {
	...
	$.ajax({
		type: 'POST',
		url: 'https://www.ovlg.com/calc/credit-card-calculators',
		data: cardValue,
		dataType: 'html',
		encode: true,
		success: function(data) {
...
function page_on_load() {
	...
	$.ajax({
		type: 'POST',
		url: 'https://www.ovlg.com/calc/debt-get-consolidation-types',
		data: onloadData,
		crossDomain: true,
		dataType: 'html',
		encode: true,
...
jQuery('#addRows').on('click',function() {
	var Optionvalues = jQuery('#rowOpt').val();
	createCardPaymentRow(Optionvalues);
	jQuery('#adLoan').hide();
});
...
$(document).ready(function() {
	...
	$('#AprNewCalculate').on("change", "#rate", function() {
		...
		url = "https://www.ovlg.com/calculators/debt-apr-calculators";
		jQuery.post(
			url, {
				principal: PrincipalValue,
				rate: RateValue,
